...
#define HW_MAX_TEMP_IC 			75.0	// AFE temp [째C]
#define HW_MAX_MOSFET_TEMP		75.0	// MOSFET TEMP [째C]
#define HW_MAX_CONNECTOR_TEMP	75.0	// power connectors and regulator max temp [째C]
#define HW_MAX_VREG_TEMP 		95.0	// max pre regulator temp [째C]
#define HW_MAX_SC_DISCHARGE_I	44.0	// short circuit current [A]
#define HW_MAX_OC_DISCHARGE_I	16.0	// overcurrent current [A]
#define HW_HYSTERESIS_TEMP		5.0		// hysteresis to avoid reconnecto on temp fault [째C]
...
#define PRECHARGE_TEMP_MAX 				70.0 // precharge resistor temp [캜]
